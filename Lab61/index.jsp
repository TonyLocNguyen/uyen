...
<body>
	...
	<div class="container">
		...
		<%
			ArrayList<Product> dsProducts = DAO.getListProduct();
		%>
		<%
			for (int i = 0; i < dsProducts.size(); i++) {
		%>
		<div class="khungsanpham">
			<div class="boder">
				<div class="img">
					<img src="<%=dsProducts.get(i).getImag()%>" width="192px"
						height="180px">
				</div>
				<div class="gia">
					<%=dsProducts.get(i).getPrice()%>
				</div>
				<div class="mua">
					<center>
						<a
							href="<%=request.getContextPath()%>/XuLyMuaSanPham?maSanPham=<%=dsProducts.get(i).getId()
							%>"><button
